...
• Display search results with article images, dates, sources, and descriptions
• Allow users to register, log in, and securely save articles to their personal collection
• View and delete saved articles on a separate page
